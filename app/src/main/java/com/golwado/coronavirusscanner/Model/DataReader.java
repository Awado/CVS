...
public class DataReader extends AsyncTask{
    ...
    protected Object doInBackground(Object[] objects) {
        System.out.println("came here!!33!!");
                ...
                if(line.contains("{"))
                    ...
                    if (line.contains("cases")) {
                        ...
                        if (numberMatcher.find()) {
                            ...
                            totalCases += Integer.parseInt(numberMatcher.group(0));
                        }
                    }
                    ...
                    if (line.contains("countryterritoryCode")) {
                        try {
                            ...
                            System.out.println(toBuildRecord); //toBuildRecord = null;
                            System.out.println(line); //toBuildRecord = null;
                        }
